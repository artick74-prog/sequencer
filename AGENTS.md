...
- Timeline markers отображаются как зелёные **флажки**. Обычный клик по флажку ставит cue на его такт; двойной клик или ПКМ открывает редактор полного названия с **Save / Copy name / Delete**. Каждый флажок жёстко ограничен шириной своей секции до следующего маркера: при широком zoom полное название видно сразу, а при узком оно обрезается ровно по доступному месту через троеточие и не наезжает на соседние маркеры. Полное имя всегда доступно в title/редакторе.
