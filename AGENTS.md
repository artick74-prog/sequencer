...
- Timeline markers отображаются как зелёные **флажки**. Обычный клик по флажку ставит cue на его такт; двойной клик или ПКМ открывает редактор полного названия с **Save / Copy name / Delete**. В самом ruler длинная подпись может быть компактной, но при hover/focus разворачивается целиком без троеточия.
