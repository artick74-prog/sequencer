...
- Высокий Velocity использовать **как смысловое событие**, обычно 1–2 акцента на такт или реже, а не равномерно.
...
- Текущий Hook Acid в **тактах 33–48** — эталон текущего вкуса пользователя по работе Velocity и swing: большинство нот имеют Velocity около 26–39, а один выраженный акцент в такте поднимается примерно до 118.
