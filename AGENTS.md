...
- Верхняя шапка MIDI Host теперь устроена как desktop-приложение: **File ▾** стоит слева перед названием проекта, а **⚙ Settings** находится в крайнем правом углу после **Справка**. В transport-панели меню File/Settings больше не дублируются.
