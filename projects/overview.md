...
## Markers (from Cubase)
- Bar 1: DJ Intro · Mix-in · 8 bars
- Bar 9: Intro · 8th hats · sparse break
- Bar 17: Groove In · hats 8ths → 16ths
- Bar 25: Development A · Main Acid · 8 bars
- Bar 33: Verse A · sparse acid · 8 bars
- Bar 41: Chorus A · full breaks · 8 bars
- Bar 49: Chorus A2 · IDEA-001 acid hook · 8 bars
- Bar 57: Chorus B · full 16th hats · 8 bars
- Bar 65: Climax · peak breaks · 8 bars
- Bar 73: Outro · 16ths → 8ths · decay
- Bar 81: DJ Outro · Mix-out · 8 bars

## Sections
- **DJ Intro · Mix-in · 8 bars** — bars 1–8
- **Intro · 8th hats · sparse break** — bars 9–16
- **Groove In · hats 8ths → 16ths** — bars 17–24
- **Development A · Main Acid · 8 bars** — bars 25–32
- **Verse A · sparse acid · 8 bars** — bars 33–40
- **Chorus A · full breaks · 8 bars** — bars 41–48
- **Chorus A2 · IDEA-001 acid hook · 8 bars** — bars 49–56
- **Chorus B · full 16th hats · 8 bars** — bars 57–64
- **Climax · peak breaks · 8 bars** — bars 65–72
- **Outro · 16ths → 8ths · decay** — bars 73–80
- **DJ Outro · Mix-out · 8 bars** — bars 81–96
...
B *...o...|*...o...|*...o...|*...o...
```
- A pitches: C2 F#2 C2 F#2 C2 F#2 C2 F#2
- B pitches: C2 F#2 C2 F#2 C2 F#2 C2 F#2
- Covers: 1–4 (2×)
- bars 1–4:
```
*...o...|*...o...|*...o...|*...o...
```
  pitches: C2 F#2 C2 F#2 C2 F#2 C2 F#2
- bars 5–7:
```
*...x...|*...x...|*...x...|*...*...
```
...
```
- A pitches: C3 C3 C2 C2 C3 C1 C3 C3 C2 C1 C3 C3
- B pitches: C3 C3 C2 C3 C1 C3 C3 C2 C2 C3 C3 A#3
- Covers: 17–24 (4×)
- bars 17, 19, 21, 23:
```
X.X.X.X.|x.X...X.|x.X.X.X.|..x.x.x.
...
```
  pitches: C3 C3 C2 C3 C1 C3 C3 C2 C2 C3 C3 A#3 C3
...
Heatmap (all tracks, avg density):
```
#.o.o.x.|x.o.x.x.|x.o.xox.|x.x.#.x.
```
**Drums** (ch 10, 200 notes)
2-bar loop (dominant):
```
A *.x.x.*.|*.x.*.o.|*.x.*.*.|*.x.*.o.
B *.x.x.*.|*.x.x.o.|*.x.*.o.|*.x.*.o.
...
*.x.x.*.|*.x.x.o.|*.x.*.*.|*.*.*.*.
```
  pitches: C2 F#2 G#2 C2 D2 F#2 G#2 F#2 C2 F#2 C2 C2 D2 D2 C2 C2
...
B ..o...o.|o.....o.|..o...X.|..o...o.
```
- A pitches: C3 C2 C3 C2 C3 D#3 C2 A#2
- B pitches: C3 C2 C3 C2 C3 D#3 C2 A#2
- Covers: 33–40 (4×)
- bars 33–40:
```
..o...o.|o.....o.|..o...X.|..o...o.
```
  pitches: C3 C2 C3 C2 C3 D#3 C2 A#2
...
B X...x...|X...x...|x...x...|x...X...
```
- A pitches: C3 C3 D#3 G3 G3 D#3 A#2 C3
- B pitches: C3 G3 A#3 G3 D#3 C3 A#2 C3
- Covers: 41–48 (4×)
- bars 41, 43, 45, 47:
```
X...x...|x...x...|x.....x.|..x...X.
```
  pitches: C3 C3 D#3 G3 G3 D#3 A#2 C3
- bars 42, 44, 46, 48:
```
X...x...|X...x...|x...x...|x...X...
```
  pitches: C3 G3 A#3 G3 D#3 C3 A#2 C3
...
B ..o.o...|X...o...|..o.o...|X.....o.
```
- A pitches: C3 C3 D#3 G3 C3 A#2 C3 G3
- B pitches: C3 C3 G3 D#3 C3 A#2 C3 D#3
- Covers: 49–56 (4×)
- bars 49, 51, 53, 55:
```
X.....o.|o.....o.|..o...o.|..X...o.
```
  pitches: C3 C3 D#3 G3 C3 A#2 C3 G3
- bars 50, 52, 54, 56:
```
..o.o...|X...o...|..o.o...|X.....o.
```
  pitches: C3 C3 G3 D#3 C3 A#2 C3 D#3
...
Heatmap (all tracks, avg density):
```
#.o.o.x.|x.o.x.x.|x.o.xox.|x.xox.xo
```
**Drums** (ch 10, 207 notes)
2-bar loop (dominant):
```
...
x.......|....x...|....x...|x...x..x
```
  pitches: G3 D3 F3 A#3 D3 F3
- bars 72:
```
x.......|x...x...|....x...|x..x...x
```
  pitches: G3 A#3 D3 F3 D3 A#3 F3
...
*...x...|*...*...|x...*.o.|*...x...
```
  pitches: C2 F#2 D2 C2 F#2 C2 D2 D2 F#2
- bars 82, 84:
```
*...x.x.|*...x.o.|*...x...|*...*...
```
  pitches: C2 F#2 C2 D2 F#2 D2 C2 F#2 D2 C2
- bars 87–88:
```
*.......|x.......|x.......|x.......
```
  pitches: C2 D2 F#2 D2

**Bass A · Kick Lock Long** (ch 1, 22 notes)
- bars 87–96:
```
........|........|........|........
```
...
## Tracks
- **Drums** (id `drums`, ch 10, xr20-drums) — 1837 notes · C2–C#3
- **Bass A · Kick Lock Long** (id `bass`, ch 1, xr20-bass · octave -1) — 405 notes · C3–C4
- **Acid** (id `acid`, ch 2, td3) — 812 notes · C1–F4
- **29 Overdriven Guitar** (id `guitar`, ch 4, gm · GM 29) — 800 notes · C3–A#3
...
- Bars 17-24: total 394 — Drums:174, Bass A · Kick Lock Long:40, Acid:108, 29 Overdriven Guitar:72
- Bars 25-32: total 464 — Drums:200, Bass A · Kick Lock Long:40, Acid:112, 29 Overdriven Guitar:112
- Bars 33-40: total 417 — Drums:201, Bass A · Kick Lock Long:40, Acid:64, 29 Overdriven Guitar:112
- Bars 41-48: total 367 — Drums:207, Bass A · Kick Lock Long:40, Acid:64, 29 Overdriven Guitar:56
- Bars 49-56: total 417 — Drums:201, Bass A · Kick Lock Long:40, Acid:64, 29 Overdriven Guitar:112
- Bars 57-64: total 423 — Drums:207, Bass A · Kick Lock Long:40, Acid:64, 29 Overdriven Guitar:112
- Bars 65-72: total 474 — Drums:207, Bass A · Kick Lock Long:43, Acid:112, 29 Overdriven Guitar:112
- Bars 73-80: total 339 — Drums:131, Bass A · Kick Lock Long:40, Acid:112, 29 Overdriven Guitar:56
- Bars 81-88: total 109 — Drums:87, Bass A · Kick Lock Long:22
- Bars 89-96: total 0 — (empty)
